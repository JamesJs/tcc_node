...
@Index("idContasPagar_UNIQUE", ["idContasPagar"], { unique: true })
@Entity("ContasPagar", { schema: "TCC" })
export class ContasPagar {
  @PrimaryGeneratedColumn({ type: "int", name: "idContasPagar" })
  ...
  @ManyToOne(() => Financeiro, (financeiro) => financeiro.contasPagars, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
